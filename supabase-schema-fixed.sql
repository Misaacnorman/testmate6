-- Create tables based on Prisma schema for Testmate6 - FIXED VERSION FOR SUPABASE
-- This version uses UUID for auth user references instead of INTEGER
...
-- Create User table - this is linked to auth.users via auth_id
CREATE TABLE "User" (
  "id" SERIAL PRIMARY KEY,
...
CREATE POLICY "Allow authenticated users to view users" ON "User" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view clients" ON "Client" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view samples" ON "Sample" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view sample tests" ON "SampleTest" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view test results" ON "TestResult" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view invoices" ON "Invoice" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view payments" ON "Payment" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view inventory" ON "InventoryItem" 
  FOR SELECT USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users to view reports" ON "Report" 
  FOR SELECT USING (auth.role() = 'authenticated');

-- Give authenticated users full access for now (you can restrict this later)
CREATE POLICY "Allow authenticated users full access to all tables" ON "User" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to clients" ON "Client" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to samples" ON "Sample" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to sample tests" ON "SampleTest" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to test results" ON "TestResult" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to invoices" ON "Invoice" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to payments" ON "Payment" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to inventory" ON "InventoryItem" 
  FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY "Allow authenticated users full access to reports" ON "Report" 
  FOR ALL USING (auth.role() = 'authenticated');